  ...
  return (
    <Book id="generative-design" title="Generative Design">
      ...
      <Page title="Media used by Generative Design" level={2}>
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="block-chain-2016">Block chain (2016)</h4>
      ...
      <Page title="3D objects">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="golden-cards-2021">Golden cards (2021)</h4>
          </div>
      ...
      <Page title="Games and virtual worlds">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="infinite-procedural-worlds-2015">Infinite procedural worlds (2015)</h4>
      ...
      <Page title="Generative Design concepts" level={2}>
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="ponyo-animation-2016">“Ponyo” animation (2016)</h4>
      ...
      <Page title="Repeatability">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="fern-profile-picture-2022">Fern profile picture (2022)</h4>
      ...
      <Page title="Randomness">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="a-tri-tree-2016">A tri-tree (2016)</h4>
      ...
      <Page title="Transformation">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="album-mood-2018">Album mood (2018)</h4>
      ...
      <Page title="Visualization">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="geocache-density-2019">Geocache density (2019)</h4>
      ...
      <Page title="Simulation">
        ...
        <div className="example">
          <div className="example-title">
            <h4 id="sheep-herding-simulation-2017">Sheep herding simulation (2017)</h4>
          </div>
...
$ Story $
- additive properties of generative design
